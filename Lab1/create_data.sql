...
BEGIN
   ...
   IF NOT EXISTS (
       ...
       RAISE NOTICE 'Table student_test created successfully';
   ELSE
       RAISE NOTICE 'Table student_test already exist';
   END IF;
   ...
   IF NOT EXISTS(
       ...
       RAISE NOTICE 'Table faculty_test created successfully';
   ELSE
       RAISE NOTICE 'Table faculty_test already exist';
   END iF;
   ...
   IF NOT EXISTS (
       ...
       RAISE NOTICE 'Table subject_test created successfully';
   ELSE
       RAISE NOTICE 'Table subject_test already exist';
   END IF;
END
$func$;
...
INSERT INTO student_test(name, surname, gender, birthday, start_study_date, finish_study_date) VALUES
...
INSERT INTO faculty_test(name, abbreviation, code_number, available_places_count) VALUES
...
INSERT INTO subject_test(name, type, classes_count, status) VALUES
